...
//                    SerializerService.DeserializeObstacle(ptr, ref obstacles[i], 0);
...
//            controlledPlayer = SerializerService.DeserializePlayer(ptr, Protocoll.PAYLOAD_OFFSET);
//	}

//	public unsafe void ExchangePlayers(ref Player controlledPlayer, ref Player[] players, bool includeControlledPlayer) {
...
//			SerializerService.SerializePlayer(ptr, controlledPlayer, Protocoll.PAYLOAD_OFFSET);
//        try {
//            Send(send);
//            byte[] packet = RecievePacket();
//            if (packet != null) {
...
//                    fixed (byte* ptr = &packet[0]) {
//                        int offset = i*Player.SizeInBytes+Protocoll.PAYLOAD_OFFSET;
//						Player player = SerializerService.DeserializePlayer(ptr, offset);
//                        if (player.PlayerUUID == controlledPlayer.PlayerUUID) {
