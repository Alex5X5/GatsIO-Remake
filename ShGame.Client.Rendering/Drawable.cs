...
/// </summary>
public unsafe abstract class Drawable(uint verticesCount) : IDisposable {

	protected uint vaoHandle = 0;
	protected uint vboHandle = 0;

	protected nuint VERTICES_COUNT = verticesCount;

	public float* VertexDataPtr = (float*)NativeMemory.AllocZeroed(verticesCount*3*sizeof(float));
