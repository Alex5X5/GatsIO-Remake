...
internal class Drawable2 {
    ...
    private readonly float[,] Vertices = { { 30, 1000, 0 }, { 500, 0, 0 }, { 0, 100, 0 } };
    ...
    public Drawable2(GL gl, float[,] vertices) {
        Console.WriteLine("[Drawable]:gl constructor");
        Setup(gl);
        Console.WriteLine(vertices.GetLength(1));
    }
