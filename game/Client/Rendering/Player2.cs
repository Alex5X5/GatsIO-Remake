...
public class Player2 : Drawable {
	...
	public Player2(Vector3d? newPos, int newHealth, Int64 UUID):base(FLOAT_COUNT) {
	...
	public Player2():base(FLOAT_COUNT) {
		Pos = new(0, 0, 0);
	...
	public static unsafe void SerializePlayer(byte[]* input, Player2* player, int offset) {
	...
	public static unsafe void DeserializePlayer(byte[]* input, Player2* player, int offset) {
		int offset_ = offset;
		if (input==null)
			return;
		*player ??= new Player2(null, 0, 0);
