...
public class Obstacle2:Drawable, SupportsShadow {
	...
	public Obstacle2(Client2? client_, Vector3d? pos_, byte type_):base(18) {
		client = client_;
	...
	public static unsafe void DeserializeObstacle(Client2? client_, byte[]* input, Obstacle2* obstacle, int offset) {
		ArgumentNullException.ThrowIfNull(*input);
		int offset_ = offset;
		*obstacle ??= new Obstacle2(client_, null, 0);
		fixed (byte* ptr = *input)
